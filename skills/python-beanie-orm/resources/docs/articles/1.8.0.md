...
Other link patterns are not supported for now. If you need something more specific for your use-case, please leave an issue on the GitHub page - [https://github.com/roman-right/beanie](https://github.com/roman-right/beanie)
...
You can validate all the values before saving the document (insert, replace, save, save\_changes) with beanie config `validate_on_save` instead.
...
If any field has a wrong value, it will raise an error on write operations (insert, replace, save, save\_changes)
...
If you would like to help with development - there are some issues at the GitHub page of the project - [https://github.com/roman-right/beanie](https://github.com/roman-right/beanie)
