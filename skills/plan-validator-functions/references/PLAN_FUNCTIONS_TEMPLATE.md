...
* **Primary entry point:** [Exact function name and signature]
* **Entry point file:** [Exact file path that contains the entry point]
* **Caller context:** [Module, backend API, job, frontend component, or other caller that invokes the entry point]
