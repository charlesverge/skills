...
Create and validate structured business-rule documentation. Use when defining or reviewing business terminology, rule areas, rule groups, rule relationships, and implementation-plan references.
